    ...
    <footer className="bg-sky-500 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Aria Toys</h3>
            <p className="text-sky-100">Качественные игрушки для развития и радости вашего ребенка</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/catalog" className="text-sky-100 hover:text-white">
                  Каталог
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-4 border-t border-sky-400 text-center text-sky-100">
          <p>&copy; {new Date().getFullYear()} Aria Toys. Все права защищены.</p>
        </div>
      </div>
    </footer>
  )
